...
#define WIFI_AP_SSID				"ESP_Javastral"			// AP name
#define WIFI_AP_PASSWORD			"damedane"			// AP password
...
#define WIFI_STA_SSID              "Mr. Swampert - Tecno"
#define WIFI_STA_PASSWORD          "AzurLane1."
