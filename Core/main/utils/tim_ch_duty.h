...
typedef struct {
    ...
    // No need for 'is_common_anode' here if passed directly to set_color
    // bool          is_common_anode; ///< True if common anode, false if common cathode
} rgb_pwm_t;
...
// Modified: Added 'is_common_anode' parameter
